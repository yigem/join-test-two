  ...
  export default {
    ...
    methods: {
      ...
      register() {
        ...
        // 调服务端注册接口
        _this.$ajax.post('/business/web/member/register', _this.memberRegister).then((response) => {
      ...
      login () {
        ...
        _this.$ajax.post('/business/web/member/login', _this.member).then((response)=>{
          let resp = response.data;
          if (resp.success) {
      ...
      loadImageCode: function () {
        ...
        let url = _this.$ajax.defaults.baseURL + 'business/web/kaptcha/image-code/' + _this.imageCodeToken;
      ...
      sendSmsForRegister() {
        ...
        _this.$ajax.get('/business/web/member/is-mobile-exist/' + _this.memberRegister.mobile).then((res)=>{
      ...
      sendSmsCode(sms, btnId) {
        ...
        // 调服务端发短信接口
        _this.$ajax.post('/business/web/sms/send', sms).then((res)=> {
          let response = res.data;
          if (response.success) {
            Toast.success("短信已发送");
      ...
      sendSmsForForget() {
        ...
        _this.$ajax.get('/business/web/member/is-mobile-exist/' + _this.memberForget.mobile).then((res)=>{
          let response = res.data;
          if (response.success) {
      ...
      resetPassword() {
        ...
        // 调服务端密码重置接口
        _this.$ajax.post('/business/web/member/reset-password', _this.memberForget).then((res)=>{
          let response = res.data;
          if (response.success) {
